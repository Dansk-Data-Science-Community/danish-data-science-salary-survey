...
def load_data() -> pd.DataFrame:
    ...
    df = (df.query('@consent == "I am happy to take part in this survey"')
            .drop(columns=["Do you agree to take part in this survey?"]))
    ...
    tools = dict(uses_high_level_language='High-level programming languages (e.g., Python, R, MATLAB, SAS, Julia, JavaScript)',
